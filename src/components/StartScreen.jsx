...
export default function StartScreen({onStart}) {
    return (
        ...
        <>
            ...
            <div className="container start-screen-container">
                <svg className="right-corner-svg" width="194" height="197" viewBox="0 0 194 197" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1>Quizzical</h1>
                <p className="start-decs">Some description if needed</p>
                <button className="start-quiz-btn" onClick={onStart}>Start quiz</button>

                <svg className="left-corner-svg"width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
